...
export default function Meal({ route, navigation }) {
  ...
  useEffect(() => {
    axios
      .get(
        `https://api.spoonacular.com/recipes/${recipeId}/information?includeNutrition=true&apiKey=7900b26e638443b5851b4c38f0f2e2e2&includeNutrition=true`
      )
      .then((res) => {
        setRecipe(res.data);
      });
              ...
              <View>
                    ...
                    <Text style={{ textAlign: "center", marginTop: 4 }}>
                      {Math.round(
                        (((amount * recipe.nutrition.nutrients[0].amount) /
                          (recipe.nutrition.nutrients[0].amount * 0.129598)) *
                  ...
                  <View>
                    ...
                    <Text style={{ textAlign: "center", marginTop: 4 }}>
                      {Math.round(
                        (((amount * recipe.nutrition.nutrients[0].amount) /
                          (recipe.nutrition.nutrients[0].amount * 0.129598)) *
                          recipe.nutrition.nutrients[8].amount) /
                          recipe.nutrition.nutrients[0].amount
                      )}{" "}
                      g
                    </Text>
                ...
                <View>
                  <View style={styles.IngredientsHeader}>
                    ...
                    <Text style={styles.IngredientsAmount}>
                      {recipe ? recipe.extendedIngredients.length : 0} Items
                    </Text>
                  </View>
                  {recipe
